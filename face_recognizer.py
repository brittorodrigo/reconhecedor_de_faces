...
for image_path in image_paths:
    ...
    for (x, y, w, h) in faces:
        ...
        threshold = 100
        if nbr_actual == nbr_predicted and conf <= 90 :
        ...
        elif nbr_actual != nbr_predicted and conf <= 10:
            print "{} eh incorretamente reconhecido como {} com nivel de confianca {}".format(nbr_actual, nbr_predicted, 100 - conf)
	    print conf
